...
export function UpNextCard({
  ...
  return (
    <div
      ...
      className={`hero-card-in flex w-full flex-col gap-5 rounded-[var(--radius-card)] border-[0.5px] border-paper/20 bg-ink/65 p-5 shadow-[0_28px_70px_-28px_rgb(0_0_0/0.85)] backdrop-blur-md ${className}`}
    >
      ...
      <div className="flex items-start gap-4">
        <PlayLink
          ...
          className="up-next-play inline-flex size-11 shrink-0 items-center justify-center rounded-full border-[0.5px] border-paper/25 bg-paper/10"
        >
